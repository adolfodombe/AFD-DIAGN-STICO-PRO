...
export const translations = {
  pt: {
    ...
    name: "Nome",
    phoneOrEmail: "Telefone",
    password: "Senha",
    register: "Registar",
    alreadyHaveAccount: "Já tem uma conta?",
    dontHaveAccount: "Não tem uma conta?",
    buyPlan: "Comprar Plano",
    freePlan: "Plano Grátis",
    premiumPlan: "Plano Premium",
    adminPlan: "Plano Administrador",
    paymentInstructions: "Após o pagamento, envie o comprovativo via WhatsApp para ativação manual do plano.",
    iban: "IBAN",
    multicaixaExpress: "Multicaixa Express",
    whatsapp: "WhatsApp",
    adminManagement: "Gestão de Utilizadores",
    ...
    lifetime: "Vitalício",
    expired: "Expirado",
    lifetimePlan: "Plano Administrador",
    trialEnded: "Acesso Grátis Terminado",
    accessExpired: "Acesso Expirado",
    trialEndedDesc: "O seu período de acesso gratuito chegou ao fim. Para continuar a utilizar o **AFD-DIAGNÓSTICO PRO** e realizar diagnósticos avançados, active a sua subscrição semanal ou mensal.",
    ...
    freeTrialDesc: "Novos utilizadores têm 3 dias de acesso total gratuito. Após o teste, escolha um plano para continuar.",
...
`
  ...
  en: {
    ...
    paymentInstructions: "After payment, send the proof via WhatsApp for manual plan activation.",
    iban: "IBAN",
    multicaixaExpress: "Multicaixa Express",
    whatsapp: "WhatsApp",
    ...
    lifetime: "Lifetime",
    expired: "Expired",
    lifetimePlan: "Admin Plan",
    trialEnded: "Free Access Ended",
    accessExpired: "Access Expired",
    trialEndedDesc: "Your free access period has ended. To continue using **AFD-DIAGNÓSTICO PRO** and performing advanced diagnostics, activate your weekly or monthly subscription.",
    ...
    freeTrialDesc: "New users have 3 days of full free access. After the trial, choose a plan to continue.",
